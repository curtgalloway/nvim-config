...
keymap.set('n', '<leader>fw', require('telescope.builtin').lsp_workspace_symbols, {})
...
keymap.set("v", "<leader>ev", function() require('jdtls').extract_variable(true) end)
keymap.set("v", "<leader>em", function() require('jdtls').extract_method(true) end)
